<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:79:"C:\eclipse-workspace\iot\public/../application/admin\view\notice\add_range.html";i:1611218412;s:67:"C:\eclipse-workspace\iot\application\admin\view\layout\default.html";i:1605513288;s:64:"C:\eclipse-workspace\iot\application\admin\view\common\meta.html";i:1605513288;s:66:"C:\eclipse-workspace\iot\application\admin\view\common\script.html";i:1605513288;}*/ ?>
<!DOCTYPE html>
         ...
         success: function (result) {
             if(result.code == '1')
             {
                ...
                for(var i in result.data){
                	option +='<option value="'+result.data[i].id+'">'+result.data[i].title+'</option>'; 
                }
