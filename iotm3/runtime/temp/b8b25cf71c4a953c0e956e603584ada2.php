<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:77:"/www/wwwroot/iotm3.yafrm.com/public/../application/admin/view/notice/add.html";i:1651917304;s:71:"/www/wwwroot/iotm3.yafrm.com/application/admin/view/layout/default.html";i:1649987434;s:68:"/www/wwwroot/iotm3.yafrm.com/application/admin/view/common/meta.html";i:1649987434;s:70:"/www/wwwroot/iotm3.yafrm.com/application/admin/view/common/script.html";i:1649987434;}*/ ?>
<!DOCTYPE html>
  ...
  <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8" style="line-height: 30px;">
            <input style="width: 36%;" id="c-keeptime" class="form-control" name="row[keeptime]" type="text" value="0">
       分钟
        </div>
    </div>
      ...
      <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8" style="line-height: 30px;">
            <input style="width: 36%;" id="c-delaytime" class="form-control" name="row[delaytime]" type="text" value="0">
       分钟
        </div>
    </div>
      <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            ...
            <label><input id="row[isOnoff]-open" name="row[isOnoff]" type="radio" value="1"  />开启</label> 
           <label><input id="row[isOnoff]-close" name="row[isOnoff]" type="radio" value="0" checked />关闭</label> 
            </div>
        </div>
    </div>
