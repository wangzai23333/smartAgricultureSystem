<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:79:"/www/wwwroot/iotm3.yafrm.com/public/../application/admin/view/linkage/edit.html";i:1695633400;s:71:"/www/wwwroot/iotm3.yafrm.com/application/admin/view/layout/default.html";i:1649987434;s:68:"/www/wwwroot/iotm3.yafrm.com/application/admin/view/common/meta.html";i:1649987434;s:70:"/www/wwwroot/iotm3.yafrm.com/application/admin/view/common/script.html";i:1649987434;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
  ...
  <div class="form-group">
    ...
    <div class="form-group">
       ...
       <option value='4'<?php if($row['switchnum'] == 4): ?>selected<?php endif; ?>>4</option>
             <option value='5' <?php if($row['switchnum'] == 5): ?>selected<?php endif; ?>>5</option>
       <option value='6' <?php if($row['switchnum'] == 6): ?>selected<?php endif; ?>>6</option>
       <option value='7'<?php if($row['switchnum'] == 7): ?>selected<?php endif; ?>>7</option>
       <option value='8'<?php if($row['switchnum'] == 8): ?>selected<?php endif; ?>>8</option>
             <option value='9' <?php if($row['switchnum'] == 9): ?>selected<?php endif; ?>>9</option>
       <option value='10' <?php if($row['switchnum'] == 10): ?>selected<?php endif; ?>>10</option>
       <option value='11'<?php if($row['switchnum'] == 11): ?>selected<?php endif; ?>>11</option>
       <option value='12'<?php if($row['switchnum'] == 12): ?>selected<?php endif; ?>>12</option>
             <option value='13' <?php if($row['switchnum'] == 13): ?>selected<?php endif; ?>>13</option>
       <option value='14' <?php if($row['switchnum'] == 14): ?>selected<?php endif; ?>>14</option>
       <option value='15'<?php if($row['switchnum'] == 15): ?>selected<?php endif; ?>>15</option>
       <option value='16'<?php if($row['switchnum'] == 16): ?>selected<?php endif; ?>>16</option>
       </select>
        </div>
    </div>
    <div class="form-group">
  ...
  <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            ...
            <div class="radio">
            <label><input id="row[operationWay]-polling" name="row[operationWay]" type="radio" value="task" <?php if($row['operationWay'] == 'task'): ?>checked<?php endif; ?> />网络(任务)</label> 
           <label><input id="row[operationWay]-task" name="row[operationWay]" type="radio" value="local" <?php if($row['operationWay'] == 'local'): ?>checked<?php endif; ?> />本地</label> 
            </div>
        </div>
    </div>
        ...
        <div class="col-xs-12 col-sm-8">
            ...
            <div class="radio">
            <label><input id="row[forbidden]-1" name="row[forbidden]" type="radio" value="1" <?php if($row['forbidden'] == 1): ?>checked<?php endif; ?> />是</label> 
           <label><input id="row[forbidden]-0" name="row[forbidden]" type="radio" value="0" <?php if($row['forbidden'] == 0): ?>checked<?php endif; ?> />否</label> 
            </div>
        </div>
    </div>
