        ...
        <div class="login-screen">
            <div class="well">
                ...
                <div class="login-form">
                    ...
                    <div style="text-align: center;">版本号：V 3.0.0</div>
                </div>
            </div>
        </div>
    </div>
