define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'task_log/index' + location.search,
                    add_url: 'task_log/add',
                    edit_url: 'task_log/edit',
                    del_url: 'task_log/del',
                    multi_url: 'task_log/multi',
                    import_url: 'task_log/import',
                    table: 'task_log',
                }
            });
